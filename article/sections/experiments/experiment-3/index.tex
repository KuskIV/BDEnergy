...
because the E-cores did not speed up the execution and Amdahl's law does not account for the lower performance of E-cores in its estimate. Further analysis can be found in \cref{app:Amdahls}
