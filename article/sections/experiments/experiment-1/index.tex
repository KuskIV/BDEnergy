...
\input{tables/results/same-cpp-multi-core-micro-benchmark-different-compiler/ipg/fannkuch-redux.exe/workstationone/clang-intel-one-api-min-gw-msvc/cpu_energy_consumption.tex}
...
<<<<<<< HEAD
\input{tables/results/same-cpp-multi-core-micro-benchmark-different-compiler/ipg/fannkuch-redux.exe/workstationone/clang-intel-one-api-min-gw-msvc/cpu_dynamic_energy_consumption.tex}
=======
