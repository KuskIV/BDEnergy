...
When setting the affinity for a process in C\#, it is done through a bitmask, where each bi represents a CPU core. An example of how it is done in C\# can be seen in \cref{lst:affinity}, where the process is allowed to execute on core \#0 and \#1.