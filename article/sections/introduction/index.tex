...
\begin{itemize}
    ...
    \item \textbf{RQ1}: How does the compiler used to compile the test cases impact the energy consumption?\label[RQ1]{RQ1}
    \item \textbf{RQ2}:What are the advantages and drawbacks of the different types of measuring instruments in terms of accuracy, ease of use, and cost?\label[RQ2]{RQ2}
    % \item \textit{How well does microbenchmarks represent a realistic usecase compared to macrobenchmarks?}
    \item \textbf{RQ3}:What effect does parallelism have on the energy consumption of the test cases?\label[RQ3]{RQ3}
    \item \textbf{RQ4}:What effect do P- and E-cores have on the parallel execution of a process, compared to a traditional desktop CPU?\label[RQ4]{RQ4}
