...
This section introduces the various C++ compilers used in the first experiment. MSVC and MinGW were included as \cite{hassan2017} found those to exhibit the lowest energy consumption. Additionally, the Intel's oneApi and Clang were included as both can be found on lists of the most popular C++ compilers\cite{mycplus, educba, softwaretestinghelp}. 
