...
\noindent\textbf{Libre Hardware Monitor (LHM):} is a fork of Open Hardware Monitor, without a GUI.\cite{LHM} Both projects are open source and LHM uses the same hardware counters and MSRs as RAPL and IPG. % and as such can measure the power domains PKG, DRAM, PP0, and PP1. 
