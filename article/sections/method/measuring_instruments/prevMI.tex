...
\noindent\textbf{Libre Hardware Monitor (LHM):} is a fork of Open Hardware Monitor, and is supported on Windows and Linux.\cite{LHM} LHM is open source and uses the same hardware counters and MSRs as RAPL and IPG. % and as such can measure the power domains PKG, DRAM, PP0, and PP1. 
