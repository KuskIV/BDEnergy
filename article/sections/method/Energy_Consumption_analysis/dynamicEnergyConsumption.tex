...
Dynamic Energy Consumption (DEC) represented a way to isolate the energy consumption of a process and was utilized in \cite{fahad2019comparative,biksbois}. DEC was used to compare software- and hardware-based measuring instruments, where the former measures energy consumption of the CPU only and the latter the entire DUT. A brief explanation of DEC based on \cite{fahad2019comparative} is given:
