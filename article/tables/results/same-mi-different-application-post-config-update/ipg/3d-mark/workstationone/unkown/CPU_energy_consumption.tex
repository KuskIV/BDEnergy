\begin{figure}[H]
    ...
    \begin{tikzpicture}[]
        ...
        \end{axis}
    \end{tikzpicture}
\caption{CPU measurements by IPG on DUT 1 for test case(s) 3DM} \label{fig:3-same-mi-different-application-post-config-update-ipg-3d-mark.exe-unkown-workstationone-cpu-energy_consumption}
\end{figure}