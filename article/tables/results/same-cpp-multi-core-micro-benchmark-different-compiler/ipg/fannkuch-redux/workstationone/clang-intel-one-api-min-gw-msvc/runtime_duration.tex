\begin{figure}[H]
    ...
    \begin{tikzpicture}[]
        ...
        \end{axis}
    \end{tikzpicture}
\caption{Runtime measurements by IPG on DUT 1 for test case(s) FR} \label{fig:1-same-cpp-multi-core-micro-benchmark-different-compiler-ipg-fannkuch-redux.exe-clang-intel-one-api-min-gw-msvc-workstationone-runtime-duration}
\end{figure}