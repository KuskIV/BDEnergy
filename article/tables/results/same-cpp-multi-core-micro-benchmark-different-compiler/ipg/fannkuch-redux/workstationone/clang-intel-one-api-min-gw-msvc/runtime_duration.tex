\begin{figure}[H]
    ...
    \begin{tikzpicture}[]
        ...
        \end{axis}
    \end{tikzpicture}
\caption{runtime measurements by ipg on workstationone for test case(s) fannkuch-redux} \label{fig:1-same-cpp-multi-core-micro-benchmark-different-compiler-ipg-fannkuch-redux.exe-clang-intel-one-api-min-gw-msvc-workstationone-runtime-duration}
\end{figure}