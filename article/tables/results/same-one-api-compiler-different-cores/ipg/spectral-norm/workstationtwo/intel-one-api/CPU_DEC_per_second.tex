\begin{figure}[H]
    ...
    \begin{tikzpicture}[]
        ...
        \end{axis}
    \end{tikzpicture}
\caption{CPU measurements by IPG on DUT 2 for benchmark(s) SN compiled on oneAPI} \label{fig:3-same-one-api-compiler-different-cores-ipg-spectral-norm.exe-intel-one-api-workstationtwo-cpu-dec_per_second}
\end{figure}