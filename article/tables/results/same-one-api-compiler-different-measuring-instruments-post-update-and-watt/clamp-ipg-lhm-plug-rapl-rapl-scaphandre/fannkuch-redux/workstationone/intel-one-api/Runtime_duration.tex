\begin{figure}[H]
    ...
    \begin{tikzpicture}[]
        ...
        \end{axis}
    \end{tikzpicture}
\caption{Runtime measurements on DUT 1 for benchmark(s) FR compiled on oneAPI} \label{fig:2-same-one-api-compiler-different-measuring-instruments-post-update-and-watt-clamp-ipg-lhm-plug-rapl-rapl-scaphandre-fannkuch-redux.exe-intel-one-api-workstationone-runtime-duration}
\end{figure}