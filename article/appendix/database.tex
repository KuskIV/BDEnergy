...
\input{tables/results/1/same-cpp-multi-core-micro-benchmark-different-compiler/ipg-lhm/fannkuch-redux.exe/workstationone/clang-intel-one-api-min-gw-msvc/cpu_dynamic_energy_consumption.tex}


%\input{tables/results/1/same-cpp-multi-core-micro-benchmark-different-compiler/ipg-lhm/fannkuch-redux.exe-mandelbrot.exe/workstationone/clang/file.tex}