...
{
    internal class LibreHardwareMonitorInstrument : MeasuringInstrument, IDisposable
    {
        ...
        public LibreHardwareMonitorInstrument(EMeasuringInstrument measuringInstrument, ILogger logger) : base(measuringInstrument)
        {
            _logger = logger;
        }
